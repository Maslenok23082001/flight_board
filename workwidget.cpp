...
void WorkWidget::editRace(int row, Plane plane)
{
    ...
    mUi->tableRaces->item(row, 3)->setText(plane.departure_time());
    mUi->tableRaces->item(row, 4)->setText(plane.arrival_time());
    mUi->tableRaces->item(row, 5)->setText(plane.status());
}
